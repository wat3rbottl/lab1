...
public class CarView extends JFrame {
    ...
    private final JButton turboOnButton = new JButton("Turbo On/Off");
    ...
    private void initComponents(String title) {
        ...
        for (JButton b : List.of(gasButton, brakeButton, turboOnButton, liftBedButton, lowerBedButton, unloadButton)) {
            b.setFont(f);
        }
    ...
    public JButton getRemoveCarButton(){return removeCarButton;}
}